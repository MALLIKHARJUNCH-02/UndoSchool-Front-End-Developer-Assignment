        ...
        <section className="mt-12">
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex mt-5 justify-center items-center flex-wrap gap-8">
                    ...
                    <div className="flex items-end cursor-pointer  PopularCategories-card p-6 speaking-card w-60 h-51 rounded-xl relative">
                    ...
                    <div className="flex items-end cursor-pointer  PopularCategories-card  p-6 chess-card w-60 h-51  rounded-xl relative">
                    ...
                    <div className="flex items-end cursor-pointer  PopularCategories-card  p-6 book-card w-60 h-51  rounded-xl relative">
                    ...
                    <div className="flex items-end cursor-pointer PopularCategories-card p-6 appbulding-card w-60 h-51  rounded-xl relative">
