        ...
        <section>
            <div>
                <div className="flex mt-5 flex-col justify-center items-center text-center">
                    ...
                    <p className="tex-center p-3">Choose the perfect time that fits your child's schedule</p>
                </div>
